...
\[
V_\mathrm{node} = V_{in}\,\frac{R_R}{R_L+R_L}.
\]
...
I denne rapporten modelleres potensiometere i Wheatstone-broen som \emph{variable motstander} $x$ i stedet for faste $R$ (rheostat-bruk). Setter vi for eksempel
\[
...
\begin{itemize}
  \item \textbf{Linjæritet}: lineær (B-taper) antas; logaritmisk (A-taper) er uegnet her.
