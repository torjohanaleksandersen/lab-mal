...
De målte verdiene viser svært små avvik fra de teoretiske beregningene. Alle målinger ligger godt innenfor komponentenes toleranse på 1\%. Utenom $I_{R2}$ som skiller seg ut. Avviket i $V_B$ er på 28\,mV, som ligger innenfor det teoretisk beregnede intervallet $[-80\text{mV}, 80\text{mV}]$ (Ligning \ref{eq:VBminmax}).
...
Spenning $V_{12} |_{maks}$ & 6.05V & 6.47V & 6.94\% \\
\bottomrule
\end{tabular}
\label{tab:results3}
\end{table}
