...
Dette delkapitlet sammenligner de målte verdiene fra laboratoriefosøket med de teoretiske beregnet utledet i kapittel \ref{sec:toeri}. Hensikten er å vurdere om resultatene følger de forventede sammenhengene Ohms lov, Kirchhoffs lover, og teorien for maske- og nodeanalyse samt Wheatstone-broen.
...
\vspace{3em}
\noindent
Samlet sett forklarer disse feilkildene de små, men målbare forskjellene mellom teoretiske og eksperimentelle verdier. De største bidragene antas å være kontaktmotstand og måleusikkerhet, mens variasjon i spenningskildene og restspenninger har mindre, men merkbar innvirkning på nøyaktigheten.I 
